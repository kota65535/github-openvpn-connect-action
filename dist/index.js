...
const normalizePath = __webpack_require__(388);
...
const readdirp = __webpack_require__(556);
const anymatch = __webpack_require__(575).default;
const globParent = __webpack_require__(547);
const isGlob = __webpack_require__(466);
const braces = __webpack_require__(610);
const normalizePath = __webpack_require__(388);

const NodeFsHandler = __webpack_require__(335);
const FsEventsHandler = __webpack_require__(771);
const {
  EV_ALL,
  EV_READY,
  EV_ADD,
...
let fsevents;
try {
  fsevents = __webpack_require__(289);
} catch (error) {
...
const sysPath = __webpack_require__(622);
const { promisify } = __webpack_require__(669);
const isBinaryPath = __webpack_require__(436);
const {
  isWindows,
  isLinux,
  EMPTY_FN,
...
var isGlob = __webpack_require__(466);
...
const Native = __webpack_require__(982);
...
var isExtglob = __webpack_require__(435);
var chars = { '{': '}', '(': ')', '[': ']'};
var strictRegex = /\\(.)|(^!|\*|[\].+)]\?|\[[^\\\]]+\]|\{[^\\}]+\}|\(\?[:!=][^\\)]+\)|\([^|]+\|[^\\)]+\))/;
var relaxedRegex = /\\(.)|(^!|[*?{}()[\]]|\(\?)/;
...
const chokidar = __webpack_require__(677)
